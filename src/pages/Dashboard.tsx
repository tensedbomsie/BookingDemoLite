    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-panel p-5" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="mb-3 text-xs text-muted-foreground">
          Set the price based on the actual job (assess scope first) — this texts a real payment link the
    ...
    <form onSubmit={save} className="max-w-sm space-y-3">
      ...
      <div className="border-t border-border pt-3">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ...
          from the Bookings tab, where you set the real amount and send an invoice the customer can pay before the
          appointment. This field only applies as a fallback if you send an invoice without typing an amount.
        </p>
      </div>
